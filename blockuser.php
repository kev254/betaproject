            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    if(isset($_POST['update'])){
                        $up_Name = mysqli_real_escape_string($con,$_POST['Name']);
                        ...
                        if(empty($up_Name) or empty($up_post_data) or empty($up_tags) or empty($up_image)){
                            $error = "All (*) Feilds Are Required";
                            
                        }
                        else{
                            $update_query = "UPDATE posts SET Name = '$up_Name', image = '$up_image', categories = '$up_categories', tags = '$up_tags', post_data = '$up_post_data', status = '$up_status' WHERE id = $edit_id";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="Name" placeholder="Type Post Name Here" value="<?php if(isset($Name)){echo $Name;}?>" class="form-control">
                                </div>
