...
+function ($) { "use strict";
  ...
  Collapse.prototype.show = function () {
    ...
    var scrollLocation = $.camelCase(['scroll', dimension].join('-'))

    this.$element
      .one($.support.transition.end, $.proxy(complete, this))
      .emulateTransitionEnd(350)
      [dimension](this.$element[0][scrollLocation])
  }
...
+function ($) { "use strict";
  ...
  Tooltip.prototype.applyPlacement = function(offset, placement) {
    ...
    // check to see if placing tip in new offset caused the tip to reLocation itself
    var actualWidth  = $tip[0].offsetWidth
    var actualHeight = $tip[0].offsetHeight
...
+function ($) { "use strict";
  ...
  , trigger: 'click'
  , content: ''
  , template: '<div class="popover"><div class="arrow"></div><h3 class="popover-Name"></h3><div class="popover-content"></div></div>'
  })
